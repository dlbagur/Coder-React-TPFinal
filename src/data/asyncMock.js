export const productos = [
  ...
  },
  {
    ...
    descripcion: "Angélica Chardonnay refleja características propias de la zona de gran altitud en donde se origina. Con días soleados y cálidos, y noches frescas al pie del Cordón del Plata, las uvas de Chardonnay adquieren una madurez plena y bien balanceada. Su color es amarillo intenso con reflejos verdosos claros. En nariz se presenta concentrado e intenso, con aromas de frutas cítricas y un toque mineral. En boca, de impacto dulce, untuoso, es brillante y fresco con sabores a frutas maduras, notas de vainilla y una excelente acidez natural que le otorga un final largo y persistente.",
    stock : 100
  },
  {
    id : 6,
  ...
  },
  {
    ...
    descripcion: "100% Chardonnay del Valle de Uco, Mendoza, Argentina. El total del volumen de este vino maduró en barricas de roble Americano y Francés de primer uso durante 12 meses. Terminada la crianza, se realizó una selección de barricas para conformar el corte de 4.000 botellas únicas.",
    stock : 100
  },
  {
    id : 8,
  ...
  },
  {
    ...
    nombre : "Gaia Rosé Orgánico",
    precio : 10000,
    img : "/imagenes/DomaineBousquetGaiaRose.jpeg",
    descripcion: "Rosa claro pálido. Aroma de fresas y frutos rojos con notas florales y de cáscara de naranja. En boca cremosidad leve y marcada acidez.",
    stock : 100
  },
  {
    id : 13,
  ...
  },
  {
    ...
    descripcion: "Caracterizado por sus 24 meses de guarda en tanque y otros 24 meses sobre borras en botella, Cruzat Cuvée se reconoce por ser un vino espumoso con cuerpo y aromas bien definidos, de carácter maduro y amable con persistentes burbujas que le dan una textura cremosa y firme.",
    stock : 100
  },
];
